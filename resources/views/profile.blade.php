...
@section('title', "Profile || Yagerdity")
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/default.png" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">{{Auth::user()->first_name}}</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        @csrf
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="first_name" value="{{Auth::user()->first_name}}" placeholder="Johnathan Doe" class="form-control form-control-line">
                                                </div>
                                            </div>
